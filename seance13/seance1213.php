...
<ul>
    ...
    <?php
        $recupId = new Formulaire('ajout_attribut.php', 'get', 'form1');
        $recupId->ajoutChampSimple('Sélection id Personnage', 'text', 'idPersonnage');
        $recupId->ajoutBoutonSubmit('Rechercher');
        echo $recupId->genereFormulaireHTML();
    ?><!-- A faire en séance 13 -->
